         ...
         <div className="max-w-[1600px] mx-auto space-y-8 p-4 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  <Card className="border-border/40 shadow-sm rounded-lg overflow-hidden">
                     ...
                     <CardContent className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                           ...
                           <Input className="h-12 bg-muted/20 border-border/40 rounded-xl text-xs font-medium" defaultValue="AI Hiring System" />
                        </div>
                        <div className="space-y-2">
               ...
               <div className="lg:col-span-4 space-y-8">
                  ...
                  {/* Data Retention */}
                  <Card className="border-border/40 shadow-sm rounded-lg overflow-hidden border-l-4 border-l-primary/50">
                     <CardHeader className="border-b border-white/5 px-8 py-6">

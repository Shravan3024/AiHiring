    ...
    <main className="min-h-screen pt-32 pb-20 px-4 md:px-8 font-sans">
      ...
      <div className="max-w-6xl mx-auto space-y-24">
        ...
        <div className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
           ...
           <div className="pt-8">
              <Link href="/register">
                 <button className="bg-slate-900 text-white px-12 py-5 rounded-2xl font-black text-xs tracking-[0.2em] uppercase hover:bg-blue-600 transition-all shadow-2xl shadow-slate-200 hover:shadow-blue-200 active:scale-95 group">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           {benefits.map((benefit, i) => (
             <div key={i} className="bg-white/60 backdrop-blur-md border border-slate-200/60 p-10 rounded-[2.5rem] hover:bg-white hover:shadow-xl transition-all group">
                <div className="p-3 bg-blue-50 text-blue-600 rounded-2xl inline-block mb-8 group-hover:bg-blue-600 group-hover:text-white transition-all">
        ...
        <section className="bg-white/40 backdrop-blur-md border border-white/20 rounded-[4rem] p-12 md:p-20 overflow-hidden relative">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
              <div className="space-y-8">
                 <h2 className="text-4xl font-black tracking-tight text-slate-900">Life at Mask Polymers</h2>
                 <div className="space-y-6 text-slate-600 font-medium leading-relaxed">
                    <p>At Mask Polymers, we don't just manufacture components; we solve complex engineering challenges. Our team is a synergy of experienced veterans and young innovators, all working toward zero-defect excellence.</p>

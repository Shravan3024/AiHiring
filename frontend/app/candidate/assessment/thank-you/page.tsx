  ...
  return (
    <div className="max-w-5xl mx-auto py-12 space-y-12">
      ...
      <div className="text-center space-y-6">
        <div className="w-24 h-24 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto shadow-lg shadow-emerald-100/50 animate-in zoom-in duration-700">
      ...
      <Card className="border-none shadow-sm rounded-[40px] bg-white p-12">
        ...
        <div className="relative">
           {/* Line */}
           <div className="absolute top-10 left-10 right-10 h-1 bg-slate-100 rounded-full" />
           
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
              {nextSteps.map((step, i) => (
                <div key={i} className="flex flex-col items-center text-center group">
                   <div className={cn(
                     "w-20 h-20 rounded-3xl flex items-center justify-center border-8 border-white shadow-xl transition-all duration-500 group-hover:scale-110",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         <Card className="border-none shadow-sm rounded-[32px] bg-white p-10 flex items-start gap-6 group hover:shadow-md transition-all">
      ...
      <div className="flex flex-col items-center gap-6 pt-8">
         <Button 
            ...
            className="bg-slate-900 hover:bg-black text-white px-12 h-16 rounded-[24px] font-black uppercase tracking-widest shadow-xl shadow-slate-200 transition-all"
         >
            Return to Dashboard
         </Button>
         <p className="text-[10px] font-bold text-slate-300 uppercase tracking-[0.3em]">Evaluation Securely Recorded by Mask Polymers AI</p>
      </div>
    </div>
  );
}

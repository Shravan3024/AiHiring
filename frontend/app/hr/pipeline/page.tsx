...
const PIPELINE_STAGES = [
  ...
  { id: "SCREENING", label: "Screening", statuses: ["RESUME_EVALUATED", "TECHNICAL_ROUND_PENDING", "PROCEED_TO_HR", "SHORTLISTED"], color: "bg-purple-500" },
  { id: "ASSESSMENT", label: "Assessment", statuses: ["TECHNICAL_ROUND_IN_PROGRESS", "TECHNICAL_ROUND_COMPLETED"], color: "bg-amber-500" },
  { id: "INTERVIEW", label: "Interview", statuses: ["INTERVIEW_SCHEDULED", "INTERVIEW_IN_PROGRESS", "INTERVIEW_COMPLETED", "INTERVIEW_UNLOCKED"], color: "bg-emerald-500" },
  { id: "OFFERED", label: "Offered", statuses: ["HR_REVIEW", "SELECTED", "OFFER_SENT", "RECOMMENDED_BY_AI", "OFFER_PENDING"], color: "bg-cyan-500" },
  { id: "HIRED", label: "Hired", statuses: ["OFFER_ACCEPTED", "HIRED", "ACCEPTED"], color: "bg-indigo-500" },
];

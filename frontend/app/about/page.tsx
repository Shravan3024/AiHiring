      ...
      <div className="max-w-6xl mx-auto space-y-24">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="max-w-2xl mx-auto text-slate-500 text-lg font-medium">
            For over two decades, Mask Polymers has been at the forefront of the automotive components industry, delivering engineered excellence to global manufacturing leaders.
          </p>
        </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="inline-flex p-3 bg-white rounded-2xl shadow-xl border border-slate-100">
               <History className="w-8 h-8 text-blue-600" />
            </div>
            <h2 className="text-3xl font-black tracking-tight text-slate-900">Our Industrial Journey</h2>
            <div className="space-y-6 text-slate-600 leading-relaxed font-medium">
              <p>
                Founded in <span className="text-slate-900 font-bold">1997</span> by pioneers in polymer technology, Mask Polymers began with a clear mission: to bridge the gap between complex engineering requirements and high-performance material solutions.
              </p>
              <p>
          ...
          <div className="relative group">
             <div className="absolute inset-0 bg-blue-600/10 rounded-[2.5rem] blur-3xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
             <div className="relative bg-white border border-slate-200/60 p-8 rounded-[2.5rem] shadow-2xl overflow-hidden aspect-video flex items-center justify-center">
        ...
        <section className="space-y-12">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-white/50 backdrop-blur-sm border border-slate-200/60 p-8 rounded-3xl hover:bg-white hover:shadow-xl transition-all group">
        ...
        <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
           ...
           <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              ...
              <button className="bg-white text-slate-900 px-10 py-4 rounded-2xl font-black text-xs tracking-widest uppercase hover:bg-blue-600 hover:text-white transition-all">
                 View Certifications
              </button>
           </div>
        </div>

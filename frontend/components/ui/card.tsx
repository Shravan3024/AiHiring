...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-3xl border bg-[var(--glass-bg)] backdrop-blur-xl shadow-[var(--glass-shadow)] border-[var(--glass-border)] transition-all duration-300 hover:shadow-[var(--glass-shadow-hover)] hover:-translate-y-0.5",
        className
      )}
      {...props}
    />
